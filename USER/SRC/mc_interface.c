...
static volatile int16_t m_curr0_samples[ADC_SAMPLE_MAX_LEN] __attribute__((section(".ccm")));
static volatile int16_t m_curr1_samples[ADC_SAMPLE_MAX_LEN] __attribute__((section(".ccm")));
static volatile int16_t m_ph1_samples[ADC_SAMPLE_MAX_LEN] __attribute__((section(".ccm")));
static volatile int16_t m_ph2_samples[ADC_SAMPLE_MAX_LEN] __attribute__((section(".ccm")));
static volatile int16_t m_ph3_samples[ADC_SAMPLE_MAX_LEN] __attribute__((section(".ccm")));
static volatile int16_t m_vzero_samples[ADC_SAMPLE_MAX_LEN] __attribute__((section(".ccm")));
static volatile uint8_t m_status_samples[ADC_SAMPLE_MAX_LEN] __attribute__((section(".ccm")));
static volatile int16_t m_curr_fir_samples[ADC_SAMPLE_MAX_LEN] __attribute__((section(".ccm")));
static volatile int16_t m_f_sw_samples[ADC_SAMPLE_MAX_LEN] __attribute__((section(".ccm")));
static volatile int8_t m_phase_samples[ADC_SAMPLE_MAX_LEN] __attribute__((section(".ccm")));
